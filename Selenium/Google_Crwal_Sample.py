...
def google_reviews(store_list,gu,count=5):

    #드라이버 실행
    options = webdriver.ChromeOptions()
    # options.add_argument("headless") #J 옵션은 일단 제거
    ...
    for store in store_list:
        ...
        result_list=[]
        sleep(3)
        query_input=driver.find_element_by_class_name('tactile-searchbox-input') # Class
        ...
        # div태그 스크롤 (자바스크립트 가져와서 excute 수행)
        sleep(8)
        js_scripts = '''
        ...
        # 헤더값 찾기 (selenium-wire 이용해서 바로 response)
